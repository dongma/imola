...
func (r *Registry) Register(ctx context.Context, si registry.ServiceInstance) error {
	...
	_, err = r.client.Put(ctx, r.instanceKey(si), string(val), clientv3.WithLease(r.sess.Lease()))
	return err
}
...
func (r *Registry) ListServices(ctx context.Context, serviceName string) ([]registry.ServiceInstance, error) {
	getResp, err := r.client.Get(ctx, r.serviceKey(serviceName), clientv3.WithPrefix())
	if err != nil {
		return nil, err
	}
...
func (r *Registry) serviceKey(sname string) string {
