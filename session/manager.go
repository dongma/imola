...
func (m *Manager) GetSession(ctx *imola.Context) (Session, error) {
...
func (m *Manager) InitSession(ctx *imola.Context, id string) (Session, error) {
...
func (m *Manager) RefreshSession(ctx *imola.Context) (Session, error) {
...
func (m *Manager) RemoveSession(ctx *imola.Context) error {
	session, err := m.GetSession(ctx)
	if err != nil {
		return err
	}
